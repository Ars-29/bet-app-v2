...
const handleInputChange = useCallback((field, value) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-4 min-[375px]:max-[390px]:px-8 min-[375px]:max-[390px]:py-8 sm:px-4 sm:py-4 lg:p-6 max-w-7xl pb-[calc(1.25rem+env(safe-area-inset-bottom))] min-[375px]:max-[390px]:pb-[calc(140px+env(safe-area-inset-bottom))] md:pb-6 min-[375px]:max-[390px]:pt-[132px]">
        {/* Header Section */}
